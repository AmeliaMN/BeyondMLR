...
\item
  ...
  \tightlist
  \item
    Discuss the pros and cons of using side-by-side boxplots vs.~stacked histograms to illustrate the relationship between year and track condition in Figure \ref{fig:bivariate}.
  \item
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{1}\SpecialCharTok{{-}}\FunctionTok{pchisq}\NormalTok{(modela2}\SpecialCharTok{$}\NormalTok{deviance, modela2}\SpecialCharTok{$}\NormalTok{df.residual)  }\CommentTok{\# GOF test}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{gof.pvalue }\OtherTok{=} \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{pchisq}\NormalTok{(pois.m1}\SpecialCharTok{$}\NormalTok{deviance, pois.m1}\SpecialCharTok{$}\NormalTok{df.residual)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtemp1 }\OtherTok{=} \FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{dark[}\DecValTok{1}\NormalTok{],moth}\SpecialCharTok{$}\NormalTok{REMOVED[}\DecValTok{1}\NormalTok{])}
\NormalTok{dtemp1 }\OtherTok{=} \FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{DISTANCE[}\DecValTok{1}\NormalTok{],moth}\SpecialCharTok{$}\NormalTok{REMOVED[}\DecValTok{1}\NormalTok{])}
\NormalTok{rtemp1 }\OtherTok{=} \FunctionTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{,moth}\SpecialCharTok{$}\NormalTok{REMOVED[}\DecValTok{1}\NormalTok{])}
\NormalTok{mtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(mtemp1,}\FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{dark[}\DecValTok{1}\NormalTok{],}
\NormalTok{                      moth}\SpecialCharTok{$}\NormalTok{PLACED[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{moth}\SpecialCharTok{$}\NormalTok{REMOVED[}\DecValTok{1}\NormalTok{]))}
\NormalTok{dtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(dtemp1,}\FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{DISTANCE[}\DecValTok{1}\NormalTok{],}
\NormalTok{                      moth}\SpecialCharTok{$}\NormalTok{PLACED[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{moth}\SpecialCharTok{$}\NormalTok{REMOVED[}\DecValTok{1}\NormalTok{]))}
\NormalTok{rtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(rtemp1,}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,moth}\SpecialCharTok{$}\NormalTok{PLACED[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{moth}\SpecialCharTok{$}\NormalTok{REMOVED[}\DecValTok{1}\NormalTok{]))}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\SpecialCharTok{:}\DecValTok{14}\NormalTok{)  \{}
\NormalTok{  mtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(mtemp1,}\FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{dark[i],moth}\SpecialCharTok{$}\NormalTok{REMOVED[i]))}
\NormalTok{  dtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(dtemp1,}\FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{DISTANCE[i],moth}\SpecialCharTok{$}\NormalTok{REMOVED[i]))}
\NormalTok{  rtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(rtemp1,}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{,moth}\SpecialCharTok{$}\NormalTok{REMOVED[i]))}
\NormalTok{  mtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(mtemp1,}\FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{dark[i],}
\NormalTok{                        moth}\SpecialCharTok{$}\NormalTok{PLACED[i]}\SpecialCharTok{{-}}\NormalTok{moth}\SpecialCharTok{$}\NormalTok{REMOVED[i]))}
\NormalTok{  dtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(dtemp1,}\FunctionTok{rep}\NormalTok{(moth}\SpecialCharTok{$}\NormalTok{DISTANCE[i],}
\NormalTok{                        moth}\SpecialCharTok{$}\NormalTok{PLACED[i]}\SpecialCharTok{{-}}\NormalTok{moth}\SpecialCharTok{$}\NormalTok{REMOVED[i]))}
\NormalTok{  rtemp1 }\OtherTok{=} \FunctionTok{c}\NormalTok{(rtemp1,}\FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,moth}\SpecialCharTok{$}\NormalTok{PLACED[i]}\SpecialCharTok{{-}}\NormalTok{moth}\SpecialCharTok{$}\NormalTok{REMOVED[i]))  \}}
\NormalTok{newdata }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{removed=}\NormalTok{rtemp1,}\AttributeTok{dark=}\NormalTok{mtemp1,}\AttributeTok{dist=}\NormalTok{dtemp1)}
\NormalTok{newdata[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{25}\NormalTok{,]}
\FunctionTok{cdplot}\NormalTok{(}\FunctionTok{as.factor}\NormalTok{(rtemp1)}\SpecialCharTok{\textasciitilde{}}\NormalTok{dtemp1)}
\end{Highlighting}
\end{Shaded}
...
\toprule
Scenario & Model & Model Name & $\hat{\beta}_0$ & SE $\hat{\beta}_0$ & $t$ & p value & $\phi$ & Est prob & CI prob & Mean count & SD count & GOF p value\\
\midrule
...
1b & Binomial & fit\_1b\_binom &  &  &  &  &  &  &  &  &  & \\
 ...
 &  &  &  &  &  &  &  &  &  &  &  & \\
\addlinespace
\textbf{Scenario} & \textbf{Model} & \textbf{Model Name} & \textbf{$\hat{\beta}_1$} & \textbf{SE $\hat{\beta}_1$} & \textbf{$t$} & \textbf{p value} & \textbf{$\phi$} & \textbf{Est odds ratio} & \textbf{CI odds ratio} & \textbf{Mean count Dose=1} & \textbf{SD count Dose=1} & \textbf{GOF p value}\\
...
\NormalTok{drop\_in\_dev }\OtherTok{\textless{}{-}} \FunctionTok{anova}\NormalTok{(model.f2ml, model.f2aml, }\AttributeTok{test =} \StringTok{"Chisq"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{re.int }\OtherTok{\textless{}{-}} \FunctionTok{ranef}\NormalTok{(model.f)}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{game}\StringTok{\textasciigrave{}}\NormalTok{[[}\StringTok{"(Intercept)"}\NormalTok{]]}
\FunctionTok{hist}\NormalTok{(re.int, }\AttributeTok{xlab =} \StringTok{"Random Effect"}\NormalTok{, }
     \AttributeTok{main =} \StringTok{"Random Effects for Game"}\NormalTok{)}
\NormalTok{Home.re }\OtherTok{\textless{}{-}} \FunctionTok{ranef}\NormalTok{(model.f)}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{hometeam}\StringTok{\textasciigrave{}}\NormalTok{[[}\StringTok{"(Intercept)"}\NormalTok{]]}
\FunctionTok{hist}\NormalTok{(Home.re, }\AttributeTok{xlab =} \StringTok{"Random Effect"}\NormalTok{, }
     \AttributeTok{main =} \StringTok{"Random Effects for Home Team"}\NormalTok{)}
\NormalTok{Visiting.re }\OtherTok{\textless{}{-}} \FunctionTok{ranef}\NormalTok{(model.f)}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{visitor}\StringTok{\textasciigrave{}}\NormalTok{[[}\StringTok{"(Intercept)"}\NormalTok{]]}
\FunctionTok{hist}\NormalTok{(Visiting.re, }\AttributeTok{xlab =} \StringTok{"Random Effect"}\NormalTok{,}
  \AttributeTok{main =} \StringTok{"Random Effects for the Visiting Team"}\NormalTok{,}
  \AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{0.5}\NormalTok{,}\FloatTok{0.5}\NormalTok{))}
\FunctionTok{cbind}\NormalTok{(Home.re, Visiting.re)   }\CommentTok{\# 39x2 matrix of REs by team}

\CommentTok{\# Prediction intervals for random effects based on Model F}
\NormalTok{ranef1 }\OtherTok{\textless{}{-}} \FunctionTok{dotplot}\NormalTok{(}\FunctionTok{ranef}\NormalTok{(model.f, }\AttributeTok{postVar =} \ConstantTok{TRUE}\NormalTok{), }
                  \AttributeTok{strip =} \ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{print}\NormalTok{(ranef1[[}\DecValTok{3}\NormalTok{]], }\AttributeTok{more =} \ConstantTok{TRUE}\NormalTok{) }\DocumentationTok{\#\#HOME}
\FunctionTok{print}\NormalTok{(ranef1[[}\DecValTok{2}\NormalTok{]], }\AttributeTok{more =} \ConstantTok{TRUE}\NormalTok{) }\DocumentationTok{\#\#VIS}
\FunctionTok{print}\NormalTok{(ranef1[[}\DecValTok{1}\NormalTok{]], }\AttributeTok{more =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
